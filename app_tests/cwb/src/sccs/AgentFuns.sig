 ...
 *
 * $Log: AgentFuns.sig,v $
 * Revision 1.2  1998/06/02 15:46:35  jont
 * Automatic checkin:
 * changed attribute _comment to ' * '
 *
 *
 *)
RCS "$Id: AgentFuns.sig,v 1.2 1998/06/02 15:46:35 jont Exp $";
signature AGENTFUNS =
  sig
    structure Ag : AGENT
    structure E : ENV
...
(* invalidated  by the rebinding of some identifier. *)
    ...
    val lookupapply : 
        (Ag.param list * Ag.agent) E.env * Ag.A.P.part list E.env
         * (Ag.A.act * Ag.A.P.part) list E.env
...
(*
    ...
    val normform : (Ag.param list * Ag.agent) E.env * Ag.A.P.part list E.env
                   * (Ag.A.act * Ag.A.P.part) list E.env
                   -> Ag.agent -> Ag.agent
    val statespace2 : (Ag.param list * Ag.agent) E.env * Ag.A.P.part list E.env
                      * (Ag.A.act * Ag.A.P.part) list E.env
