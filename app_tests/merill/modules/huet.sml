 ...
 *
 * $Log: huet.sml,v $
 * Revision 1.2  1998/06/08 18:15:16  jont
 * Automatic checkin:
...
This file contains an implementation of the Huet's Left-Linear Completion Algorithm, modified
...
fashion as to make the rule sort-increasing.  It will also fail if the given rule is not 
left-linear.
