...
Summary: Harlequin MLWorks 2.0m2 
Name: mlworks
Version: 2.0m2
Release: 1
Source: mlworks-2.0m2.tar.gz
...
AutoReqProv: no
%description  
 MLWorks (TM) 2.0m2 for Linux.  Harlequin Group plc.  
...
rm -rf $RPM_BUILD_DIR/mlworks-2.0m2/
...
echo "Installed MLWorks 2.0m2 for Linux in " $RPM_INSTALL_PREFIX
