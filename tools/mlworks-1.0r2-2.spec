...
Summary: Harlequin MLWorks 1.0r2 
Name: mlworks
Version: 1.0r2
Release: 2
Source: mlworks-1.0r2.tar.gz
Copyright: Copyright (c) 1997 The Harlequin Group Ltd.  All rights reserved.
Vendor: The Harlequin Group Limited
Group: Development/Languages/SML
Prefix: /usr/local/lib/MLWorks
AutoReqProv: no

%description  
  MLWorks (TM) 1.0r2 for Linux.  Harlequin Group plc.  
...
$RPM_BUILD_DIR/mlworks-$VERSION/install-mlworks /usr/local/lib/MLWorks
...
rm -rf $RPM_BUILD_DIR/mlworks-$VERSION/
...
$ln $MLWORKSDIR/unix $MLWORKSDIR/system
...
echo "Installed MLWorks 1.0r2 for Linux in " $RPM_INSTALL_PREFIX
