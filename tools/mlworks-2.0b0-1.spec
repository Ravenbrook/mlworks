...
Summary: Harlequin MLWorks 2.0b0 
Name: mlworks
Version: 2.0b0
Release: 1
Source: mlworks-2.0b0.tar.gz
...
AutoReqProv: no
%description  
 MLWorks (TM) 2.0 Beta for Linux.  Harlequin Group plc.  
...
rm -rf $RPM_BUILD_DIR/mlworks-2.0b0/
...
echo "Installed MLWorks 2.0 Beta for Linux in " $RPM_INSTALL_PREFIX
...
%attr (- ${LOGNAME} ${GROUP}) /usr/local/lib/MLWorks
