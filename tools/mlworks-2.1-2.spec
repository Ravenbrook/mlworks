...
Summary: Harlequin MLWorks 2.1
Name: mlworks
Version: 2.1
Release: 1
Source: mlworks-2.1.tar.gz
...
AutoReqProv: no
%description  
 MLWorks (TM) 2.1 for Linux.  Harlequin Group plc.  
...
rm -rf $RPM_BUILD_DIR/mlworks-2.1/
...
echo "Installed MLWorks 2.1 for Linux in " $RPM_INSTALL_PREFIX
