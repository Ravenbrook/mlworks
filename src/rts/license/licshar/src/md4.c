 ...
 *
 * $Log: md4.c,v $
 * Revision 1.6  1999/01/04 09:03:09  jamesr
 * [Bug #30447]
 * modifications for NT
 *
 * Revision 1.5  1994/05/17  21:50:31  freeland
 * -inserting current code, with Log keyword and downcased #includes
 *
   1994-Mar-29-19:29 harry
        [Task number: 3465]
        Add proper return values.
   1993-Oct-8-16:30 chrism
        move LOWBYTEFIRST to ls.h
1992-Oct-16-13:23 chrism = adding std types
1992-Oct-7-12:26 chrism = Created
...
static void MDblock(MDptr MDp, uint32 *X)
{
...
** if desired.
*/
void MDupdate(MDptr MDp, uint8 *X, uint32 count)
{ 
